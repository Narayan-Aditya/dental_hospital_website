...
export const Concept3ProMax: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen font-sans antialiased selection:bg-teal-600 selection:text-white transition-colors duration-200">
      ...
      {/* 1. TOP UTILITY BAR (Luxury Dark Glass) */}
      <div className="bg-slate-950 text-slate-300 text-xs py-2 px-4 sm:px-6 lg:px-8 border-b border-slate-800/80 transition-colors">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-3">
          {/* Left: Location & Timings & Fast Phone Helpline */}
          <div className="flex items-center space-x-4 flex-wrap gap-y-1.5 text-[11px] sm:text-xs">
            <div className="flex items-center text-teal-400 font-semibold tracking-wide">
              <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse mr-2 shrink-0 shadow-sm shadow-emerald-400/50" />
              <span>Sadrauna, Mohan Road, Lucknow</span>
            </div>
            <div className="hidden md:flex items-center text-slate-400 font-medium border-l border-slate-800 pl-4">
          ...
          {/* Right: Verified Badges, Social Platforms, Theme & Language */}
          <div className="flex items-center space-x-2.5 sm:space-x-3 text-xs">
            {/* Social & Review Hub */}
            <div className="flex items-center space-x-1.5 border-r border-slate-800 pr-2.5 sm:pr-3">
              <a 
                href={HOSPITAL_INFO.socialLinks.google} 
                target="_blank" 
                rel="noreferrer" 
                className="text-amber-400 hover:text-amber-300 transition-all text-[11px] font-bold px-2 py-0.5 rounded-lg bg-slate-900 hover:bg-slate-850 border border-slate-800 flex items-center space-x-1 shadow-sm hover:scale-105"
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="text-orange-400 hover:text-orange-300 transition-all text-[11px] font-bold px-2 py-0.5 rounded-lg bg-slate-900 hover:bg-slate-850 border border-slate-800 hidden sm:flex items-center space-x-1 shadow-sm hover:scale-105"
            ...
            <button
              ...
              className="p-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-amber-300 transition-all border border-slate-800 hover:scale-105 shadow-sm"
      ...
      <nav className="sticky top-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800/80 py-3 transition-all duration-300 shadow-sm shadow-slate-900/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center gap-4">
          {/* Brand Logo & Clinic Identity */}
          <a href="#" className="flex items-center space-x-3.5 group shrink-0">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-teal-700 via-teal-600 to-emerald-500 flex items-center justify-center text-white shadow-lg shadow-teal-600/25 group-hover:scale-105 group-hover:shadow-teal-600/35 transition-all duration-200 ring-1 ring-white/20 shrink-0">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <span className="font-display font-extrabold text-xl text-slate-900 dark:text-white tracking-tight whitespace-nowrap group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors">
                  HOPE DENTAL
                </span>
                <span className="bg-teal-50 dark:bg-teal-950/80 text-teal-700 dark:text-teal-300 border border-teal-200/60 dark:border-teal-800 text-[10px] font-extrabold px-2 py-0.5 rounded-full uppercase tracking-wider whitespace-nowrap shadow-2xs">
                  Sadrauna
                </span>
              </div>
          ...
          {/* Book Appointment Primary Action (CTA) */}
          ...
          <div className="flex items-center space-x-2 lg:hidden">
            <button
              onClick={() => setIsBookingOpen(true)}
              className="sm:hidden px-3.5 py-1.5 text-xs font-bold text-white bg-gradient-to-r from-teal-600 to-emerald-500 rounded-xl shadow-md whitespace-nowrap active:scale-95 transition-transform"
            >
              {language === 'hi' ? 'बुक स्लॉट' : 'Book Slot'}
            </button>
            <button
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl border-b border-slate-200 dark:border-slate-800 px-4 pt-3 pb-6 mt-2 shadow-2xl animate-fadeIn space-y-3">
            <div className="flex flex-col space-y-1 font-semibold text-slate-700 dark:text-slate-200 text-sm">
              <a 
                href="#about" 
                onClick={() => setMobileMenuOpen(false)} 
                className="px-3.5 py-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors flex items-center justify-between"
              >
              ...
              <a 
                ...
                className="px-3.5 py-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors flex items-center justify-between"
              >
                <span>{language === 'hi' ? 'मरीज समीक्षाएं' : 'Patient Reviews'}</span>
                <ArrowRight className="w-4 h-4 text-slate-400" />
              </a>
              <a 
                href="#blogs" 
            ...
            <div className="pt-3 border-t border-slate-100 dark:border-slate-800 space-y-2">
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-teal-600 to-emerald-500 text-white rounded-xl font-bold flex items-center justify-center shadow-lg shadow-teal-600/25"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 dark:text-white leading-[1.14]">
                {language === 'hi' ? (
                  <>
              ...
              <div className="grid grid-cols-3 gap-4 pt-2 border-y border-slate-200 dark:border-slate-800 py-4">
                <div>
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400">{language === 'hi' ? 'संतुष्ट मरीज' : 'Patients Treated'}</div>
                </div>
                <div>
                  <div className="font-serif font-bold text-2xl text-teal-700 dark:text-teal-400">100% Painless</div>
                  <div className="text-xs text-slate-500 dark:text-slate-400">{language === 'hi' ? 'कम्प्यूटरीकृत सुन्न तकनीक' : 'Computerized Numbing'}</div>
                </div>
                <div>
                  <div className="font-serif font-bold text-2xl text-slate-900 dark:text-white">Class-B</div>
                  <div className="text-xs text-slate-500 dark:text-slate-400">{language === 'hi' ? '4-स्तरीय स्टरलाइजेशन' : '4-Tier Sterilization'}</div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                ...
                <a
                  href="#services"
                  className="px-6 py-3.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-900 dark:hover:bg-slate-800 text-slate-800 dark:text-slate-200 font-bold text-sm rounded-2xl border border-slate-200 dark:border-slate-800 transition-all flex items-center space-x-2"
                >
      ...
      <section id="about" className="py-20 bg-slate-50 dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2 text-xs font-semibold text-slate-800 dark:text-slate-200">
                <div className="flex items-center space-x-2">
                  ...
                  <span>14+ {language === 'hi' ? 'वर्षों का अनुभव' : 'Years Experience'}</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle2 className="w-4 h-4 text-teal-700 dark:text-teal-400" />
      ...
      {/* SECTION 3: WHAT SERVICES HOSPITAL PROVIDES (3D Dental Arch Anatomy + Treatment Catalog) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="lg:col-span-7 bg-slate-50 dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
                ...
                <div className="text-right">
                  <div className="text-xs text-slate-500 dark:text-slate-400">{language === 'hi' ? 'शुरुआती फीस' : 'Starting Fee'}</div>
              ...
              <div className="pt-2">
                ...
                >
                  <span>{language === 'hi' ? 'इस उपचार के लिए अपॉइंटमेंट बुक करें' : 'Book Appointment for this Treatment'}</span>
                  <ArrowRight className="w-4 h-4" />
                </button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {treatments.slice(0, 6).map((t) => (
              <div 
                key={t.id}
                className="bg-slate-50 dark:bg-slate-900 rounded-3xl p-6 border border-slate-200/90 dark:border-slate-800 flex flex-col justify-between hover:shadow-xl hover:border-teal-500/40 transition-all group"
              >
                <div className="space-y-3">
                  ...
                  <h3 className="font-serif font-bold text-lg text-slate-900 dark:text-white group-hover:text-teal-600 transition-colors">
                ...
                <div className="pt-5 mt-4 border-t border-slate-200/80 dark:border-slate-800 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-3.5 py-1.5 bg-teal-700 hover:bg-teal-800 dark:bg-teal-600 dark:hover:bg-teal-700 text-white font-bold text-xs rounded-xl shadow transition-all flex items-center space-x-1"
                  >
      ...
      <section id="doctors" className="py-20 bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800">
      ...
      <section id="reviews" className="py-20 bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <span className="text-xs font-extrabold uppercase tracking-widest text-teal-800 dark:text-teal-400">
              Verified Feedback
      ...
      <section id="blogs" className="py-20 bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <span className="text-xs font-extrabold uppercase tracking-widest text-teal-800 dark:text-teal-400">
              Patient Education
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {blogs.slice(0, 3).map((b) => (
              <div 
                key={b.id} 
                className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 flex flex-col justify-between hover:shadow-lg transition-all cursor-pointer"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-6 space-y-6">
              {/* Address Card */}
              <div className="bg-slate-50 dark:bg-slate-900 p-6 sm:p-7 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-4 shadow-sm">
                <div className="flex items-start space-x-3.5">
                  <div className="w-11 h-11 rounded-2xl bg-teal-700 text-white flex items-center justify-center shrink-0 shadow-md">
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-xs sm:text-sm bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500 shadow-sm"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full text-xs sm:text-sm bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-3 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-teal-500 shadow-sm"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full text-xs sm:text-sm bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500 shadow-sm resize-none"
                    />
                  </div>

                  <button
                    type="submit"
                    className="w-full py-3.5 bg-teal-700 hover:bg-teal-800 dark:bg-teal-600 dark:hover:bg-teal-700 text-white font-bold text-sm rounded-xl shadow-lg shadow-teal-700/25 transition-all flex items-center justify-center space-x-2"
                  >
      ...
      {/* FOOTER */}
      <footer className="py-14 bg-slate-950 text-slate-400 border-t border-slate-800 text-xs">
      ...
      {selectedBlog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-2xl w-full max-h-[85vh] overflow-y-auto border border-slate-200 dark:border-slate-800 p-6 sm:p-8 space-y-4 shadow-2xl relative">
            <button
            ...
            <div className="flex items-center space-x-4 text-xs text-slate-500 dark:text-slate-400 pb-3 border-b border-slate-200 dark:border-slate-800">
            ...
            <div className="prose prose-sm dark:prose-invert max-w-none text-slate-700 dark:text-slate-300 leading-relaxed text-sm">
            ...
            <div className="pt-4 border-t border-slate-200 dark:border-slate-800 flex justify-end">
              <button
                ...
                className="px-5 py-2.5 bg-teal-700 text-white font-bold text-xs rounded-xl shadow"
              >
