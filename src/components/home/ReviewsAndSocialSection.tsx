  ...
  return (
    <section id="reviews" className="py-20 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 transition-colors duration-300 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-14 bg-gradient-to-r from-slate-900 via-slate-800 to-teal-950 text-white rounded-3xl p-6 sm:p-8 border border-slate-700/80 shadow-2xl">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 items-center text-center">
            ...
            <div className="space-y-1.5 border-r border-slate-700/60 pr-4">
              ...
              <div className="text-[11px] text-slate-300">480+ Verified Ratings</div>
              <a
                href={HOSPITAL_INFO.socialLinks.google}
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center text-[11px] text-teal-400 hover:text-teal-300 font-semibold mt-1 space-x-1"
              >
            ...
            {/* JustDial Rating */}
            <div className="space-y-1.5 lg:border-r border-slate-700/60 pr-4">
              ...
              <div className="text-[11px] text-slate-300">Top Rated in Sadrauna</div>
              <a
                href={HOSPITAL_INFO.socialLinks.justdial}
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center text-[11px] text-orange-400 hover:text-orange-300 font-semibold mt-1 space-x-1"
              >
            ...
            <div className="space-y-1.5 border-r border-slate-700/60 pr-4">
              <div className="text-red-500 font-extrabold text-2xl sm:text-3xl flex items-center justify-center space-x-1">
                <YoutubeIcon className="w-7 h-7 text-red-500 mx-auto" />
              </div>
              <div className="text-xs font-bold text-white">YouTube Videos</div>
              <div className="text-[11px] text-slate-300">Patient Education</div>
              <a
                href={HOSPITAL_INFO.socialLinks.youtube}
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center text-[11px] text-red-400 hover:text-red-300 font-semibold mt-1 space-x-1"
              >
            ...
            <div className="space-y-1.5">
              <div className="text-blue-400 font-extrabold text-2xl sm:text-3xl flex items-center justify-center space-x-1">
                <FacebookIcon className="w-7 h-7 text-blue-400 mx-auto" />
              </div>
              <div className="text-xs font-bold text-white">Facebook Page</div>
              <div className="text-[11px] text-slate-300">Hospital Updates</div>
              <a
                href={HOSPITAL_INFO.socialLinks.facebook}
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center text-[11px] text-blue-400 hover:text-blue-300 font-semibold mt-1 space-x-1"
              >
                <span>Facebook Hub</span>
                <ExternalLink className="w-3 h-3" />
              </a>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="bg-slate-50 dark:bg-slate-800/80 rounded-3xl p-6 border border-slate-200/80 dark:border-slate-700 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between"
            >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-[10px] font-extrabold uppercase px-2.5 py-0.5 rounded-full ${
                    review.verifiedSource === 'Google'
                      ...
                      ? 'bg-orange-100 dark:bg-orange-950/60 text-orange-800 dark:text-orange-300 border border-orange-200/60 dark:border-orange-800'
              ...
              {/* Patient info */}
              <div className="pt-4 border-t border-slate-200/70 dark:border-slate-700 mt-4 flex items-center justify-between text-xs">
                <div>
                ...
                <div className="text-right">
                  <div className="text-[11px] font-bold text-teal-700 dark:text-teal-400">{review.treatmentReceived}</div>
        ...
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                Watch our patient transformations and clinic walk-throughs in Sadrauna, Lucknow.
              </p>
            </div>
            <a
              href={HOSPITAL_INFO.socialLinks.youtube}
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white font-bold text-xs rounded-xl shadow-md transition-all space-x-1.5 self-start sm:self-auto"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {videoTestimonials.map((v) => (
              <div
                key={v.id}
                className="bg-white dark:bg-slate-800 rounded-3xl overflow-hidden shadow-md hover:shadow-xl border border-slate-200/80 dark:border-slate-700 group relative flex flex-col justify-between transition-all"
              >
                ...
                <div className="p-4 bg-white dark:bg-slate-800 text-slate-900 dark:text-white">
                  <h4 className="font-bold text-sm line-clamp-1 group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors">
