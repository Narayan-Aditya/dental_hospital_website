      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {doctors.map((doctor) => (
            <div
              key={doctor.id}
              className="bg-slate-50 dark:bg-slate-800/80 rounded-3xl border border-slate-200/80 dark:border-slate-700 overflow-hidden hover:shadow-2xl hover:border-teal-300 dark:hover:border-teal-500 transition-all duration-300 flex flex-col justify-between group"
            >
              ...
              <div className="relative h-64 overflow-hidden bg-slate-800">
                ...
                {/* Rating Badge */}
                <div className="absolute top-3 right-3 bg-white/95 dark:bg-slate-900/90 backdrop-blur-sm text-slate-900 dark:text-white px-2.5 py-1 rounded-full text-xs font-bold shadow flex items-center space-x-1">
              ...
              <div className="p-5 sm:p-6 space-y-3 flex-1 flex flex-col justify-between">
                ...
                <div className="pt-2">
                  ...
                  {/* Availability */}
                  <div className="text-[11px] text-slate-600 dark:text-slate-300 flex items-start space-x-1.5 bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700 mb-3">
                  ...
                  {/* Languages */}
                  <div className="flex items-center space-x-1 text-[11px] text-slate-500 dark:text-slate-400 mb-4">
                  ...
                  <button
                    ...
                    className="w-full py-2.5 bg-slate-900 dark:bg-teal-600 hover:bg-teal-600 dark:hover:bg-teal-700 text-white font-bold text-xs rounded-xl shadow transition-all flex items-center justify-center space-x-1.5"
                  >
